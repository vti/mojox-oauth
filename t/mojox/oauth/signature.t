...
my $sig = MojoX::OAuth::Signature->new(
...
is($sig->signing_key, 'MCD8BKwGdgPHvAuvgvz4EQpqDAtx89grbuNMRd7Eh98&');
is($sig->to_string,   '8wUi7m5HFQy76nowoCThusfgB+Q=');

$sig = MojoX::OAuth::Signature->new(
...
is($sig->to_string, 'PUw/dHA4fnlJYM6RhXk5IU/0fCc=');
...
is($sig->to_string, 'yOahq5m0YjDDjfjxHaXEsW9D+X0=');
